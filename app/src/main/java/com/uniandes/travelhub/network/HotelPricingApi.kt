...
interface HotelPricingApi {
    ...
    @GET("api/v1/search/hotel/pricing/targets")
    suspend fun listTargets(): List<HotelPricingTargetOption>

    @POST("api/v1/search/hotel/pricing/preview")
    suspend fun preview(@Body body: HotelPricingPreviewRequest): HotelPricingPreviewResponse

    @POST("api/v1/search/hotel/pricing/apply")
    suspend fun apply(@Body body: HotelPricingApplyRequest): HotelPricingApplyResponse

    @GET("api/v1/search/hotel/pricing/history")
    suspend fun listHistory(): List<HotelPricingHistoryItem>

    @POST("api/v1/search/hotel/pricing/history/{changeId}/revert")
